<aside class="main-sidebar" style="background-color: #BAB9B9">
  ...
  <section class="sidebar" style="background-color: #BAB9B9">
    ...
    <ul class="sidebar-menu" data-widget="tree" style="background-color: #786974; color:white; font-size: 15px; font-family:Times">
      ...
      <li><a href="votes.php"><span class="glyphicon glyphicon-lock"></span> <span>Votes</span></a></li>
      ...
      <!-- Logs Section -->
      <li class="header" style="background-color: #28272D; color:white; font-size: 12px; font-family:Times">LOGS</li>
      <li><a href="logs.php"><i class="fa fa-history"></i> <span>View Logs</span></a></li>

      <!-- Procedures Section -->
      <li class="header" style="background-color: #28272D; color:white; font-size: 12px; font-family:Times">PROCEDURES</li>
      <li><a href="procedures.php"><i class="fa fa-database"></i> <span>Procedure</span></a></li>

      <!-- Aggregate Section -->
      <li class="header" style="background-color: #28272D; color:white; font-size: 12px; font-family:Times">AGGREGATE</li>
      <li><a href="aggregate.php"><i class="fa fa-signal"></i> <span>Aggregate</span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>
