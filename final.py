...
class voting_system:
    ...
    def sign_up(self):
        ...
        Age = date.today().year - Birthday_date.year - ((date.today().month, date.today().day) < (Birthday_date.month, Birthday_date.day))
        if Age < 18:
        ...
        while True:
            ...
            if '@' in Email and '.' in Email and (Email.index("@") < Email.index(".") < len(Email) - 1):
                break
            else:
        ...
        while True:
           ...
           DistrictId = int(input("District ID"))
           break
    ...
    # Insert values using parameterized query to prevent SQL injection
        query = """
        INSERT INTO voter_table (Aadhaar, FirstName, MiddleName, LastName, Gender, Birthday, Age, Phone, Email, DistrictId)
    ...
    def login(self):
        while True:
            ...
            Password = input("Password: ")
            query = "SELECT Def_Password FROM user_table WHERE VoterId = %s AND AADHAR = %s"
            cur = self.db.cursor()
            try:
                ...
                if result:
                    ...
                    print("Invalid VoterId or Aadhaar")
    ...
    def add_candidate(self,Aadhaar):
        ...
        while True:
            ...
            if len(CandidateAadhaar)!=15 : print("Invalid length of Leader's Aadhaar no.!\n")
